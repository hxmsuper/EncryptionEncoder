...
namespace Encoder
{
    public class Encoder
    {
        ...
        public static string DESEncrypt(string code, string sKey,string iv)
        {
            /* 创建一个DES加密服务提供者 */
            DESCryptoServiceProvider des = new DESCryptoServiceProvider();
        ...
        /// 创建RSAKey
        /// </summary>
        /// <param name="size"> keySize</param>
        /// <returns></returns>
        public static RSAKey CreateRSAKey(int size)
        {
            RSAKey rsaKey = new RSAKey();    //声明一个RSAKey对象
